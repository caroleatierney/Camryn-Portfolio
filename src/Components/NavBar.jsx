...
export default function NavBar() {
  return (
    <div className="bg-webPageBackground flex xs:flex-wrap md:flex-row p-3 md:text-md lg:text-lg xl:text-2xl lg:flex-row flex-col justify:center lg:justify-evenly text-xs lg:text-xl text-lightGrayText items-center">
