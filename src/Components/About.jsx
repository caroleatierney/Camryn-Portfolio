...
export default function About() {
  return (
    <div className="bg-webPageBackground">
      <NavBar />
      <div className="text:sm sm:text-3xl md:text-4xl lg:text-3xl xl:text-5xl w-5/6 items-center justify-center pt-10 mx-auto bg-gray-200 text-gray-500 p-2 text-center mt-12 tracking-tight dark:text-white flex flex-col md:flex-row">
