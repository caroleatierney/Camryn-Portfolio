      ...
      <div className="flex flex-wrap justify-center items-center mx-auto p-6 w-5/6">
        <Card className="text-xxs sm:text-sm md:text-lg md:text-sm lg:text-4xl xl:text-2xl w-full text-center font-normal tracking-tight bg-gray-300 text-gray-900 dark:text-white">
          <div className="flex flex-col lg:flex-row xl:flex-row justify-evenly w-7/8">
            <div className="flex flex-col items-center mx-auto w-1/2 pb-5">
              <div className="border-4 border-uMassRed bg-gray-200 flex flex-wrap items-center w-full xl:p-5 min-h-full min-w-full">
                <img
                  className="object-scale-down max-h-full drop-shadow-md m-auto p-2 xl:p-0"
            ...
            <div className="flex flex-col items-center mx-auto w-1/2 xl:p-5">
              <div className="border-4 border-uMassRed bg-gray-200 lg:flex-col flex flex-wrap items-center mx-auto justify-center min-h-full min-w-full">
                <img
                  className="object-scale-down max-h-full drop-shadow-md rounded-md m-auto p-2 md:p-12 lg:p-12 xl:p-0"
                  src={UMassLogo}
                  alt="UMass-Logo"
                />
                <span className="inline-block justify-center align-middle leading-loose font-serif mx-auto text-xxs md:text-xl lg:text-2xl xl:text-2xl">
