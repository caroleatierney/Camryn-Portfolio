        ...
        <Card className="w-full text-center font-bold tracking-tight bg-gray-300 text-gray-900 dark:text-white">
          <div className="flex flex-row justify-evenly">
            <div className="flex flex-col items-center w-1/2">
              <div className="flex flex-wrap bg-gray-200 border-8 p-10 m-5 border-red-900 h-full justify-center">
                <img
                  className="pb-10"
            ...
            <div className="flex flex-col items-center w-1/2">
              <div className="border-8 border-red-900 bg-gray-200 p-10 m-5 flex flex-wrap items-center">
                <img
