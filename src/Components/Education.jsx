            ...
            <div className="flex flex-col items-center mx-auto w-full tablet:p-3">
              <div className="border-4 border-uMassRed bg-gray-200 flex flex-wrap mx-auto tablet:px-5 min-h-full min-w-full justify-center align-middle">
                <img
                  ...
                  alt="UMass-Logo"
                />
                <span className="flex flex-col leading-loose font-serif mx-auto text-xxs smallestMobile:text-xxxxs smallMobile:text-xxs smallMedMobile:text-md tablet:text-sm laptop:text-xl desktop:text-2xl largeScreen:text-3xl items-center justify-center desktop:pt-3">
