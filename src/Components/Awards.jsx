...
export default function Awards() {
  return (
    <div className="bg-webPageBackground text-mediumGrayText w-3/4 mx-auto mt-20">
      <NavBar />
      <div className="text:xxs smallestMobile:text-xs smallMedMobile:text-sm tablet:text-lg laptop:text-xl desktop:text-2xl largeScreen:text-3xl w-5/6 regularMobile:pt-6 text-center items-center justify-center mx-auto bg-backgroundGray p-2 tracking-tight dark:text-white flex flex-col mb-2 mt-12">
        <div>
